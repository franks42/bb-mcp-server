#!/usr/bin/env bb
;; Test runner for bootstrap configuration and CLI features
;; Usage: bb test/run_bootstrap_tests.clj
...
(def test-namespaces
     ...
     '[;; CLI argument parsing tests
       bb-mcp-server.cli.parse-args-test
       ;; Nickname and port file tests
       bb-mcp-server.pid-file-test])

(println "=" (apply str (repeat 60 "=")))
(println "Running Bootstrap Configuration Tests")
(println "=" (apply str (repeat 60 "=")))
(println)
