(ns mcp-nrepl.tools.nrepl-connection
    "Unified nREPL connection tool for MCP - handles connect, disconnect, status operations"
    (:require [mcp-nrepl.state.connection :as state]
              [mcp-nrepl.client.connection :as conn]
              [mcp-nrepl.client.handlers] ;; Load handlers to install watchers
