(ns mcp-nrepl.tools.nrepl-send-message
...
(defn handle
  ...
  (cond
    ...
    message-id
    (delegate/call-async-tool "mcp-nrepl.nrepl-get-result-async"
    ...
    :else
    (let [send-result (delegate/call-async-tool "mcp-nrepl.nrepl-send-message-async"
