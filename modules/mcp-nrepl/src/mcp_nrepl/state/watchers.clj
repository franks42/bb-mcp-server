(ns mcp-nrepl.state.watchers
    "Watchers for async message processing - Phase 2b.2&3 (DUMB WATCHERS + RECEIVE)"
    (:require [mcp-nrepl.state.messages :as msg-state]
              [mcp-nrepl.state.connection :as conn-state]
              [mcp-nrepl.state.results :as results]
              [mcp-nrepl.client.operations :as nrepl-ops]
              [mcp-nrepl.client.messaging :as messaging]
              [bencode.core]
