#!/usr/bin/env bb
;; Test runner for sente-browser module
;; Usage: bb modules/sente-browser/test/run_tests.clj

(require '[clojure.test :as test])

(def test-namespaces
     "List of test namespaces to run."
     '[sente-browser.server-test])

(println "=" (apply str (repeat 60 "=")))
(println "Running Sente-Browser Module Tests")
(println "=" (apply str (repeat 60 "=")))
(println)
