(ns nrepl.tools.introspection-test
   ...
   Integration tests (requiring live nREPL) are in a separate file."
    (:require [clojure.test :refer [deftest is testing]]
              ...
              [nrepl.tools.nrepl-loaded-namespaces :as loaded-ns]
              [nrepl.tools.nrepl-introspect-ns :as introspect-ns]
              [nrepl.tools.nrepl-var-meta :as var-meta]
              [nrepl.tools.nrepl-get-value :as get-value]))
